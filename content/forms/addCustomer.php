<?php
    ...
    if (isset($_POST['insert'])) {
        ...
        $customer_phoneno = $_POST['customer_phoneno'];
            ...
            $sqlCustomer = "INSERT INTO customer(customer_name, customer_address, customer_phoneno) VALUES ('$customer_name','$customer_address','$customer_phoneno')";   


            if (mysqli_query($conn, $sqlCustomer)) 
            {
                $successmsz = 'New Customer Details successfully inserted. ';
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Add New Customer</h3>
                        <ol class="breadcrumb">
                            ...
                            <div class="card-block">
                                <form class="form-horizontal form-material" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="customer_name" class="form-control form-control-line" name="example-email" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Customer Address</label>
                                        <div class="col-md-12">
                                            <input type="text" name="customer_address" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Customer Phone Number</label>
                                        <div class="col-md-12">
                                            <input type="number" name="customer_phoneno" class="form-control form-control-line">
                                        </div>
                                    </div>
