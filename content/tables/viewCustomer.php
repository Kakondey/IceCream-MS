                                        ...
                                        <?php
                                            ...
                                            <tbody>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="../updateForms/updateCustomer.php?edit=1&customer_id=<?php echo $row->customer_id; ?>" ><input class="btn btn-primary btn-small" value="EDIT" type="submit" name="EDIT"></a></td>
                                                </tr>
                                            </tbody>
                                        <?php
                                                }
