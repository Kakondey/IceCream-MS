<?php
    ...
    if (isset($_GET['delete'])) {
            $sqlD = "DELETE FROM product WHERE product_id='{$_GET['product_id']}'";
            $dQuery = mysqli_query($conn,$sqlD);

            if ($dQuery) {
                header('Refresh:1; deleteProduct.php');
            }
    }
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Delete Product Details</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../../index.php">Home</a></li>
                            <li class="breadcrumb-item"><a href="../section/deleteSection.php">DELETE Section</a></li>
                            <li class="breadcrumb-item active">delete product details</li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
                                        ...
                                        <?php
                                            ...
                                            <tbody>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="deleteProduct.php?delete=1&product_id=<?php echo $row->product_id; ?>" ><input class="btn btn-primary btn-small" value="DELETE" type="submit" name="DELETE"></a></td>
                                                </tr>
                                            </tbody>
                                        <?php
                                                }
