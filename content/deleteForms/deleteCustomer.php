<?php
    ...
    if (isset($_GET['delete'])) {
            $sqlD = "DELETE FROM customer WHERE customer_id='{$_GET['customer_id']}'";
            $dQuery = mysqli_query($conn,$sqlD);

            if ($dQuery) {
                header('Refresh:0; deleteCustomer.php');
            }
    }
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">View Customer Details</h3>
                        <ol class="breadcrumb">
                                        ...
                                        <?php
                                            ...
                                            <tbody>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td><a href="deleteCustomer.php?delete=1&customer_id=<?php echo $row->customer_id; ?>" ><input class="btn btn-primary btn-small" value="DELETE" type="submit" name="DELETE"></a></td>
                                                </tr>
                                            </tbody>
                                        <?php
                                                }
